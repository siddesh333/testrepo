...
1. **Datadog Integration Setup**:
   - Create the Terragrunt configuration in this repository
   - Run `terragrunt apply` to create the Datadog integration
...
1. Capture the **External ID** generated by Datadog from the Terragrunt output
